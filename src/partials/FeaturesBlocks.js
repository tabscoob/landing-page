      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Una plataforma para el desarrollo de tecnología y generación de datos abiertos.</h2>
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              {/* <svg className="w-16 h-16 p-1 -mt-1 mb-2" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
               ...
               <img src={require('../images/research-01.svg').default} width="60" height="60" alt="Research" /> 
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Research</h4>
              <p className="text-gray-600 text-center">Una plataforma de procesamiento de datasets implementando la tecnologia de notebooks  Jupyter usando diferentes lenguajes de programación como Python, C#, SCALA, etc …</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              {/* <svg className="w-16 h-16 p-1 -mt-1 mb-2" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
               ...
               <img src={require('../images/iot.svg').default} width="60" height="60" alt="Research" /> 
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">IoT</h4>
              <p className="text-gray-600 text-center">Una red de telemetría mqtt gratuita para los miembros de la comunidad Tabscoob A.I </p>
            </div>
            ...
            {/* <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Blog</h4>
