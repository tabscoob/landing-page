      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h2 className="h2 mb-4">Equipo</h2>
            <p className="text-xl text-gray-600" data-aos="zoom-y-out">
              Somos un grupo de ingenieros, investigadores y entusiastas de las
              ciencias, los datos y la innovación con experiencia en diferentes ambientes tecnológicos y sociales.
            </p>
          </div>
          ...
          <div className="max-w-sm md:max-w-4xl mx-auto grid gap-2 grid-cols-4 md:grid-cols-3 ">
            ...
            <div className="flex items-center justify-center py-2 col-span-2 md:col-auto">
              <div class=" bg-white  mx-auto shadow-lg rounded-lg hover:shadow-xl transition duration-200 max-w-sm">
                <img
                  src={require("../images/dev1.jpg").default}
                  width="300"
                  height="32"
                  alt="Tabscoob AI"
                />
                <div class="py-4 px-8">
                  ...
                  <p class="hover:cursor-pointer py-3 text-gray-600 leading-6">
                    Founder, Sofware developer, data engineer
                  </p>
                  <div class="flex flex-row gap-4 text-gray-800 my-auto text-2xl mx-auto md:mx-0">
                    <a href="https://www.linkedin.com/in/devcsar"  class="hover:cursor-pointer hover:text-blue-500">
                      <i class="fab fa-linkedin"></i>
                    </a>

                    <a  href="https://twitter.com/devcsar"  class="hover:cursor-pointer hover:text-blue-500">
                      <i class="fab fa-twitter-square"></i>
                    </a>
                    <a  href="https://github.com/devcsar"  class="hover:cursor-pointer hover:text-blue-500">
            ...
            <div className="flex items-center justify-center py-2 col-span-2 md:col-auto">
              <div class=" bg-white  mx-auto shadow-lg rounded-lg hover:shadow-xl transition duration-200 max-w-sm">
                <img
                  src={require("../images/dev2.jpg").default}
                  width="300"
                  height="32"
                  alt="Tabscoob AI"
                />
                <div class="py-4 px-8">
                  ...
                  <p class="hover:cursor-pointer py-3 text-gray-600 leading-6">
                    Co-founder, Community experience manager
                  </p>
                  <div class="flex flex-row gap-4 text-gray-800 my-auto text-2xl mx-auto md:mx-0">
                    <a   href="https://www.linkedin.com/in/marcoszequera"  class="hover:cursor-pointer hover:text-blue-500">
                      <i class="fab fa-linkedin"></i>
                    </a>
                    <a  href="https://www.facebook.com/marcos.deyvis.jesus"  class="hover:cursor-pointer hover:text-blue-500">
                      <i class="fab fa-facebook-square"></i>
                    </a>
                    <a  href="https://www.instagram.com/marcoszequera"  class="hover:cursor-pointer hover:text-blue-500">
            ...
            <div className="flex items-center justify-center py-2 col-span-2 md:col-auto col-start-2 col-end-2">
              <div class=" bg-white  mx-auto shadow-lg rounded-lg hover:shadow-xl transition duration-200 max-w-sm">
                <img
                  src={require("../images/dev3.jpg").default}
                  width="300"
                  height="32"
                  alt="Tabscoob AI"
                />
                <div class="py-4 px-8">
                  ...
                  <p class="hover:cursor-pointer py-3 text-gray-600 leading-6">
                    Co-founder, No-code product developer
                  </p>
                  <div class="flex flex-row gap-4 text-gray-800 my-auto text-2xl mx-auto md:mx-0">
                    <a  href="https://www.linkedin.com/in/valente-flores-72171a125/"  class="hover:cursor-pointer hover:text-blue-500">
                      <i class="fab fa-linkedin"></i>
                    </a>

                    <a  href="https://twitter.com/mxvalenteflores"  class="hover:cursor-pointer hover:text-blue-500">
                      <i class="fab fa-twitter-square"></i>
                    </a>
                    <a  href="https://www.instagram.com/mxvalenteflores"  class="hover:cursor-pointer hover:text-blue-500">
                      <i class="fab fa-instagram-square"></i>
                    </a>
                  </div>
                </div>
          ...
          {/* <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center" data-aos="zoom-y-out" data-aos-delay="300">
                <div>
                  <a className="btn text-white blue-tabscoob hover:bg-blue-700 w-full mb-4 sm:w-auto sm:mb-0" href="https://forms.office.com/r/Lb825bY0J4">Quiero ser colaborador</a>
                </div>
                <div>
