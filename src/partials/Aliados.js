      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h2 className="h2 mb-4">Aliados  </h2>
            <p className="text-xl text-gray-600" data-aos="zoom-y-out">Estamos trabajando en conjunto con otras iniciativas y proyectos de código abierto.  </p>
          </div>
          ...
          <div className="max-w-sm md:max-w-4xl mx-auto grid gap-2 grid-cols-4 md:grid-cols-5 ">
            ...
            {/* Item */}
            <div className="flex items-center justify-center py-2 col-span-2 md:col-auto">
            <a href="https://www.jetbrains.com/community/user-groups/" class="hover:cursor-pointer hover:text-blue-500">
                      
                    
            <img src={require('../images/jetbrains.svg').default} width="120" height="32" alt="Tabscoob AI" /> 
            </a>
            </div>

            <div className="flex items-center justify-center py-2 col-span-2 md:col-auto">
            <a href="https://dotnetfoundation.org" class="hover:cursor-pointer hover:text-blue-500">
                      
                    
            <img src={require('../images/dotNetFoundationHorizontal.svg').default} width="170" height="32" alt="Tabscoob AI" /> 
            </a>
            </div>
            ...
            {/* Item */}
             ...
             <a href="https://2021.spaceappschallenge.org/locations/villahermosa-tabasco" class="hover:cursor-pointer hover:text-blue-500">
               <img src={require('../images/Square_Black.svg').default} width="120" height="61" alt="Tabscoob AI" /> 
               </a>
            </div> 
              ...
              {/* Item */}
                 ...
                 <div className="flex items-center justify-center py-2 col-span-2 md:col-auto">
                 <a href="https://uninformatico.com/" class="hover:cursor-pointer hover:text-blue-500">
                   <img src={require('../images/uninformatico.jpg').default} width="90" height="100" alt="Tabscoob AI" /> 
                   </a>
              
            </div>
            <div className="flex items-center justify-center py-2 col-span-2 md:col-auto">
              
            <a href="https://www.facebook.com/Netschool.io" class="hover:cursor-pointer hover:text-blue-500">
                      
                    
            <img src={require('../images/logo_netschool.svg').default} width="120" height="32" alt="Tabscoob AI" /> 
            </a>
            </div>
